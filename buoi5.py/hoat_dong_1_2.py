...
# HOAT DONG 2: Vận dụng if – Xếp loại học lực, tìm số lớn nhất
#Bài tập 2.1 – Xếp loại học lực đầy đủ (hoàn thiện lại bài đã làm ở Buổi 1 và 4):
ho_ten = "Nguyen Van A"
